...
public class BoardNotice extends BaseTimeEntity {
    @Id //해당 테이블의 PK필드
    ...
    public BoardNotice(String title, String content, String writer, int view,
                       String filename,String filepath, User user) {
        this.title = title;
