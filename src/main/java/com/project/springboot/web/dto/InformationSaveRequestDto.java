...
@Setter
@NoArgsConstructor
public class InformationSaveRequestDto {
    ...
    @Builder
    public InformationSaveRequestDto(String title,String content, String writer,String filename
                                  ,String filepath, int view, User user){
